      ...
      <div className="xl:col-span-5 flex items-center">
        ...
        >
          <h1 className="text-4xl xl:text-6xl text-white tracking-widest xl:leading-[5.5rem]">
            INVIERTE EN
            <span className="text-diamante px-3 py-1 border border-primary_isla rounded-md ml-2">CANCUN</span>
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Your paradise starts here! Your legacy is the most important thing.
          </p>
...
export default SeccionInvestmentEn
