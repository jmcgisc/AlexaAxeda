                ...
                <div className="grid grid-cols-1">  
                    <h1 className="text-[45px] text-axeda font-title px-6 lg:px-24 mt-10 lg:mt-18 ">
                        ...
                        <p className ="lg:text-xl text-lg xl:font-body font-serif text-bold text-justify text-gray-700 px-6 lg:px-24 py-2">
                            Terrenos residenciales al norte de Mérida. Un paraíso con mensualidades desde $2,181.64 MXN 
                        </p>   
                    ...
                    <h2 className="text-axeda text-3xl font-title py-2 mt-3 px-6 lg:px-24">
                        ...
                        <p className="lg:text-xl text-lg xl:font-body font-serif text-justify tracking-widest text-gray-700 px-6 lg:px-24 py-2 mb-4">
                            Nuestros terrenos se encuentran dentro de un desarrollo residencial con amenidades que aseguran tu calidad de vida, seguridad y la plusvalía de tu patrimonio, a sólo 5 minutos de uno de los centros comerciales más grandes del mundo. 
                        </p>
                </div> 
            </div>
            ...
            {/* <img className="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96" src="https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"alt=""/> */}
                ...
                <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                    ...
                    <div className="object-cover mt-4 lg:mt-0 w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96">
                        <YoutubeEmbed embedId="D9ttuMsC6Hc" />
                    </div> 
    ...
    {/*Cotizador Cancún*/} 
        ...
        <div className="grid grid-cols-1 flex flex-cols lg:grid-cols-8 bg-orange-700 lg:bg-gradient-to-r from-orange-500 to-orange-900">
            <div className="lg:col-start-2 lg:col-end-8 mb-5 ">
                <h1 className="text-lg lg:text-5xl font-title text-white text-center underline mt-5">
                    ¡ INVIERTE DESDE $2,181.64 MXN AL MES ! 
                </h1> 
        </div>
        ...
        <div className="lg:col-start-2 lg:col-end-8 mb-5 text-center">
            <span className="text-xl xl:leading-[5.5rem] text-cyan-100 px-24 py-2 border-8 border-axeda relative inline-block">
                <a className="text-white font-title lg:font-body text-base lg:text-5xl mt-5"
                href={"https://crm.rosavento.mx/cotizador/ciudad-maya/greco_cdmaya/greco_alto?vendedor=MTk2%0A"} target="_blank" rel="noopener noreferrer">
                    Cotiza aquí TU lote en Greco Alto
                </a> 
                    <RiCheckboxBlankCircleFill className="text-orange-400 text-base absolute -left-4    -top-4 p-2 bg-axeda rounded-full box-content"/>
                    <RiCheckboxBlankCircleFill className="text-orange-400 text-base absolute -right-4   -top-4 p-2 bg-axeda rounded-full box-content"/>
                    <RiCheckboxBlankCircleFill className="text-orange-400 text-base absolute -left-4    -bottom-4 p-2 bg-axeda rounded-full box-content"/>
                    <RiCheckboxBlankCircleFill className="text-orange-400 text-base absolute -right-4   -bottom-4 p-2 bg-axeda rounded-full box-content"/>
            </span> 
        </div>
    ...
    {/*Cotizador Cancún*/}  
        <div className="grid grid-cols-1 flex flex-cols lg:grid-cols-8 bg-emerald-500 lg:bg-gradient-to-r from-emerald-900 to-emerald-300">
            <div className="lg:col-start-2 lg:col-end-8 mb-5 ">
                <h1 className="text-4xl xl:text-4xl font-title text-white text-center underline text-lg text-2xl lg:text-5xl mt-5">
                    ¡ INVIERTE DESDE $3,527.33 MXN AL MES ! 
                </h1> 
            </div>
        ...
        <div className="lg:col-start-2 lg:col-end-8 mb-5 text-center">
            <span className="text-xl  xl:leading-[5.5rem] text-cyan-100 px-24 py-2 border-8 border-emerald-100 relative inline-block">
                <a className="text-white font-title lg:font-body text-base lg:text-5xl mt-5"
                href={"https://crm.rosavento.mx/cotizador/cancun/cancun_levante/abrego_alto?vendedor=MTk2%0A"} target="_blank" rel="noopener noreferrer">
                    Cotiza aquí TU lote en Cancún
                </a> 
                        <RiCheckboxBlankCircleFill className="text-emerald-400 text-base absolute -left-4   -top-4 p-2 bg-emerald-100 rounded-full box-content"/>
                        <RiCheckboxBlankCircleFill className="text-emerald-400 text-base absolute -right-4  -top-4 p-2 bg-emerald-100 rounded-full box-content"/>
                        <RiCheckboxBlankCircleFill className="text-emerald-400 text-base absolute -left-4   -bottom-4 p-2 bg-emerald-100 rounded-full box-content"/>
                        <RiCheckboxBlankCircleFill className="text-emerald-400 text-base absolute -right-4  -bottom-4 p-2 bg-emerald-100 rounded-full box-content"/>
                </span> 
        </div>   

        <div className ="lg:col-start-2 lg:col-end-8 mb-5">
            <h2 className ="text-gray-800 text-basea lg:text-3xl text-white text-center font-sans text-justify px-12 py-2"> 
                El lugar perfecto para disfrutar de la vida que siempre quisiste, en el caribe mexicano, financiamiento hasta 120 meses.
            </h2>
        </div> </div>
