    ...
    <section className="min-h-screen bg-gradient-to-b from-white to-diamonBlack dark:from-black dark:to-gray-900 py-36 px-6 md:px-16 text-black dark:text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-10">
          ...
          >
            <p className="mb-6">
              Azores represents the sophistication of minimalism: spaces with clean lines, calm atmospheres and an aesthetic that embraces the essential. 
              With a pool for adults, a children's pool, and terraces designed for contemplation, this private property offers a refuge with character.
            </p>
            <p>
              The clubhouse incorporates a multipurpose room, pergola with grill bar, and a refined room with firepit for intimate outdoor evenings.
              The theme park, with its distinctive mini golf course, provides an elevated recreational experience, ideal for those who find pleasure in well-executed details.
            </p>
          </motion.div>
        </div>
