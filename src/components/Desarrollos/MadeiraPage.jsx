    ...
    <section className="min-h-screen bg-gradient-to-b from-white to-diamonBlack dark:from-black dark:to-gray-900 py-36 px-6 md:px-16 text-black dark:text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-10">
          ...
          >
            <p className="mb-6">
              Un santuario para el deporte y la vitalidad. Parque temático de gimnasio y multicanchas. Cancha multideporte, gimnasio equipado. Albercas, terrazas y salón de usos múltiples.
            </p>
            <p>
              Una comunidad visionaria donde cada día es una experiencia extraordinaria.
            </p>
          </motion.div>
        </div>
