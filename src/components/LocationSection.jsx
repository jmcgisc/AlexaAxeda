  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        <iframe
          title="Ubicación Isla Diamante Cancún"
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6">
        <motion.h2
          className="text-4xl md:text-5xl font-bold text-diamante md:mt-32 mt-12 mb-6"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
        >
          Una ubicación con visión de futuro
        </motion.h2>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Isla Diamante se sitúa en el nuevo polo de crecimiento urbano en Cancún. Una zona estratégica con gran conectividad, plusvalía y desarrollo planificado.
        </motion.p>
        ...
        >
          ...
          <span>Ubicación: Isla Diamante Cancún, Q. Roo</span>
        </motion.div>
      </div>
    </section>
  );
