...
const PreguntasFrecuentes = () => {
    return (
        ...
        <div>
            <h1 className="text-axeda text-center font-title text-2xl lg:text-5xl mt-12 mb-4"><span>Axeda </span>-Producto Ampliado-</h1>
        </div> 
        ...
        <ul role="list" className="marker:text-axeda list-disc pl-5 space-y-3 text-slate-700 mb-3 mt-3">
            <li>6 carriles de acceso en vialidades centrales (3 de ida y 3 de vuelta).</li>
            <li>4 carriles de acceso en vialidades secundarias (2 de ida y 2 de vuelta).</li>
            <li>3 carriles de acceso en vialidades internas de la multi-privada (1.5 de ida y 1.5 de vuelta).</li>
            <li>1.5 carriles de acceso en vialidades internas de cada privada.</li>
        </ul>

        <div>
            <h1 className="text-axeda text-center font-title text-2xl lg:text-5xl mt-12 mb-4"><span>Axeda </span>-Características-</h1>
        </div> 
        ...
        <ul role="list" className="marker:text-axeda list-disc pl-5 space-y-3 text-slate-700 mb-3 mt-3">
            <li>10 minutos reales de Puerto Progreso.</li>
            <li>20 minutos reales de Chelem.</li>
            <li>25 minutos reales de Chuburná.</li>
            <li>60 minutos reales de Celestún.</li>
        </ul>
