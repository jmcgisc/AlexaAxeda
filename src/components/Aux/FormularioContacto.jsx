                ...
                <div className ="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-6 bg-cyan-700 p-8 rounded-xl shadow-lg text-white overflow-hidden">  
                        ...
                        <div className="relative z-10 bg-white rounded-xl shadow-lg hover:shadow-indigo-500/40 p-8 text-gray-600 md:w-90 " >
                            ...
                            <form onSubmit={handleSubmit} id="form" action ="" className="flex flex-col space-y-4 " >
                                ...
                                <InputEmail value={values.email}            handleChange={handleChange} label ="E-mail"                 aria-labelledby="E-Mail"          name="email"            type="email"    placeholder="realtor.alexadelgado@gmail.com " />
                                <SelectFieldsBudget                         handleChange={handleChange} label ="Inversión"              aria-labelledby="Inversión estimada para el enganche" name="presupuesto"  />
                                <SelectFieldsInvestment                     handleChange={handleChange} label ="Destino de la compra"   aria-labelledby="Destino de la compra"                name="interesadoEn" />
