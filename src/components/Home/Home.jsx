...
export const Home = () => {
    return ( 
        ...
        <div className="md:col-span-5 flex items-center justify-center p-12 py-8 xl:p-16">
            ...
            <div className="container px-6 çlg:py-8 mx-auto">
                <h1 className="text-3xl font-title text-center text-axeda capitalize lg:text-4xl"> 
                  Evento de "Supervisión de obra de " <strong className="underline decoration-axeda/[.33]"> ROSAVENTO Ciudad Maya.</strong>
                </h1>
  
                <div className="lg:mt-14 lg:-mx-6 lg:flex lg:items-center">
                    <div className="object-cover  w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96">
                          <div className="App">
                              <YoutubeEmbed embedId="FEHDi1T5dFM" />
                          </div>
                    </div> 
                            <div className="lg:w-1/2 lg:mt-0 lg:mx-6 "> 
                                <p className="block text-2xl font-semibold text-axeda hover:underline md:text-3xl">
