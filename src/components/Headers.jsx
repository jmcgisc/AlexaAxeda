    ...
    return (
     <header className="flex flex-cols items-center justify-between  w-full py-4 px-8 h-[10vh] z-50" >
      ...
      >
         ...
         <div className ="inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 text-sm text-center font-mono font-medium text-gray-700 shadow-sm 
