...
const Headers = () => {
  ...
  return (
    <div>
      ...
      <div className="fixed top-0 left-0 w-full text-sm py-1 px-4 flex justify-end items-center gap-2 z-50 bg-gray-800 text-white transition-colors duration-300">
